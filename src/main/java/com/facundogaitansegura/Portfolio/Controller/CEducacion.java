...
import com.facundogaitansegura.Portfolio.Dto.dtoEducacion;
...
import com.facundogaitansegura.Portfolio.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        educacion.setLink(dtoeducacion.getLink());
